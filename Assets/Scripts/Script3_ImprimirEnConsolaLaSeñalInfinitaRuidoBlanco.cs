...
public class Script3_ImprimirEnConsolaLaSeñalInfinitaRuidoBlanco: MonoBehaviour  //creo mi clase que se llama como el script 
...
//                                 ║                     Variables                   ║                                                               ║
//                                 ╚═════════════════════════════════════════════════╝
    private bool VariableReproducirSeñal = true; // variable booleana que nos servirá para reproducir o no la señal,
    ...
    private bool VariableYaMostreLasMuestras = false; //OnAudioFilterRead() no se ejecuta una sola vez. 
